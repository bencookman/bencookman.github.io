...
(This is a short post, because the idea and execution are both pretty simple. If they aren't to you, there are plenty of resources on the internet to explain these things --- especially the Mandelbrot set --- in more detail. I'm really not sure I could do any better a job explaining/motivating these topics than those who've talked about this stuff on the internet before anyway.)
...
The code can be seen and downloaded a [at this GitHub repository](https://github.com/bencookman/consolebrot-zig). Ignoring all the build system and low-level riff-raff, the program can be boiled down to some simple pseudocode:
...
Here is some of the ASCII, copied directly from the terminal output.
